requirejs(["Quaternion", "Input", "InputGroup"], function (Quaternion, Input, InputGroup) {
  $(function () {
      ...
      function addDataPoint(series) {
        ...
        //
        //
        // if(time >= 9.9999 && time < 10.001) {
        //   console.log(
        //     "t=" + time,
        //     next
        //   );
        // }
        // if(time >= 19.9999 && time < 20.001) {
        //   console.log(
        //     "t=" + time,
        //     next
        //   );
        ...
        if ((parmVals.fromSeries<=calcP) && (calcP<=parmVals.toSeries)) {
          trData.push(next);
          data[series]=trData;
          document.getElementById("for_dots").insertAdjacentHTML("beforeEnd", "<tr><td>"+calcP+"</td><td>"+next[0]+"</td><td>"+next[2]+"</td><td>"+next[3]+"</td></tr>");
